...
class JunyiTopicByTitleAgent(Agent): # Inherit from Agent
    def __init__(self):
        super().__init__(
            ...
            tags=["教育", "標題查詢"],
            parameters=[
                {"name": "title", "type": "str", "description": "主題標題關鍵字，僅允許中英文與數字", "pattern": "^[\\u4e00-\\u9fa5a-zA-Z0-9 ]+$"} # Escaped unicode range
            ],
            example_queries=[
                "查詢標題為『分數』的主題內容"
            ],
    ...
    def respond(self, title: str): # ensure 'self' is present
